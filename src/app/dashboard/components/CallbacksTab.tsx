        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="bg-zinc-900 border-zinc-800 shadow-xl border-cyan-500/5">
            ...
            <CardContent className="pt-8 px-8 pb-8 space-y-6">
              <div className="flex items-center justify-between p-6 rounded-2xl bg-cyan-500/5 border border-cyan-500/10">
                 <div className="space-y-1">
                 ...
                 <Button
                    className="bg-cyan-500 hover:bg-cyan-600 h-12 rounded-xl px-8 font-bold shadow-lg shadow-cyan-500/10"
              ...
              <div className="grid gap-4">
                 ...
                 <div className="pt-4 border-t border-zinc-800 space-y-4">
                    <div className="flex justify-between items-center">
                       ...
                       <Badge className="bg-cyan-500/10 text-cyan-400 border-cyan-500/20">{dailyReport.followUpsCompleted}</Badge>
                    </div>
                    <div className="flex justify-between items-center">
