                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center">
                           <Phone className="w-6 h-6 text-zinc-500 group-hover:text-emerald-400 transition-colors" />
                        </div>
                        <div className="space-y-1">
                    ...
                    <div className="mt-8 pt-8 border-t border-zinc-800/50 space-y-4">
                       ...
                       {(campaign.results || []).length > 6 && (
                         <div className="pt-2 px-2 flex items-center justify-between">
                            ...
                            <Button variant="link" className="text-emerald-500 text-xs h-auto p-0 font-bold group/btn" onClick={() => loadCampaignToComposer(campaign)}>
