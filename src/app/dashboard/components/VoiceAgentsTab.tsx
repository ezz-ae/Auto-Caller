    ...
    <div className="space-y-8 animate-in fade-in-50 duration-200">
        ...
        <CardHeader className="pb-8 bg-zinc-950/50 border-b border-zinc-800/50">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 px-4 py-2">
              <p className="text-xs text-cyan-400 font-bold uppercase tracking-widest">Active Agents</p>
        ...
        <CardContent className="space-y-10 pt-8 px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-zinc-800/50 border-zinc-700 h-12 rounded-xl focus:ring-cyan-500/50"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <Button
                      type="button"
                      className="bg-cyan-500 hover:bg-cyan-600 h-11 px-8 rounded-xl shadow-lg shadow-cyan-500/20"
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <Button
              ...
              className="bg-cyan-500 hover:bg-cyan-600 h-14 px-10 text-lg font-bold rounded-2xl shadow-xl shadow-cyan-500/20"
            >
            ...
            {callerIdentities.length === 0 ? (
              ...
              <div className="grid gap-4">
                {callerIdentities.map(identity => {
                  ...
                  return (
                    <div key={identity.id} className={`group rounded-2xl border p-6 transition-all duration-300 ${isActive ? 'border-cyan-500/50 bg-cyan-500/10 shadow-lg shadow-cyan-500/5' : 'border-zinc-800 bg-zinc-950/40 hover:border-zinc-700'}`}>
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                        <div className="space-y-3">
                          <div className="flex items-center gap-3">
                            <div className="w-12 h-12 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center font-bold text-cyan-400">
                          ...
                          <div className="space-y-1 pl-1">
                             ...
                             <div className="flex items-center gap-6 mt-4">
                                ...
                                <div className="space-y-0.5">
                                   ...
                                   <p className="text-sm font-bold text-cyan-400">{identity.connectedCalls}</p>
                                </div>
                                <div className="space-y-0.5">
                                   <p className="text-[10px] uppercase text-zinc-500 font-bold tracking-widest">Success</p>
                                   <p className="text-sm font-bold text-cyan-400">{successRate}%</p>
                                </div>
                             </div>
                          </div>
                        </div>
      ...
      <div className="flex items-start gap-3 p-6 bg-zinc-900/50 rounded-2xl border border-zinc-800/50">
        ...
        <p className="text-sm font-medium text-zinc-400 leading-relaxed">
          Your agents are specialized to handle different markets and goals. Assign them to campaigns in the <span className="text-cyan-400 font-bold">Call Center</span> to start reaching your leads.
        </p>
      </div>
    </div>
  )
