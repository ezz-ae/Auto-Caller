  ...
  return (
    <div className="space-y-10 animate-in fade-in-50 duration-200">
      <div className="grid gap-8 xl:grid-cols-3">
          ...
          <CardHeader className="pb-8 bg-zinc-950/50 border-b border-zinc-800/50">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm font-semibold text-orange-400">{readinessScore}% Complete</p>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {startSteps.map((step, index) => (
                <button
                  ...
                  className="group relative rounded-2xl border border-zinc-800 bg-zinc-950/40 p-5 text-left hover:border-orange-500/30 hover:bg-zinc-900/50 transition-all duration-300"
                >
                  <p className="text-xs text-zinc-500 uppercase tracking-widest font-bold">Step {index + 1}</p>
                  <p className="text-base text-zinc-200 mt-2 font-semibold group-hover:text-orange-400 transition-colors">{step.label}</p>
                  <Badge className={`mt-4 ${step.done ? 'bg-orange-500/10 text-orange-400 border-orange-500/20' : 'bg-amber-500/10 text-amber-400 border-amber-500/20'}`}>
        ...
        <Card className="bg-zinc-900 border-zinc-800 shadow-lg border-orange-500/5">
          ...
          <CardContent className="space-y-4 px-6 pb-8">
            ...
            >
              <Wallet className="w-4 h-4 mr-3 text-orange-400" />
              Recharge Credits
            </Button>
            <Button 
              variant="secondary" 
            ...
            >
              <CalendarClock className="w-4 h-4 mr-3 text-orange-400" />
              Review Schedule
            </Button>
            <Button
              variant="secondary"
            ...
            <Button 
              className="w-full justify-start h-14 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-lg shadow-orange-500/20" 
        ...
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="text-xl font-bold text-orange-400">{successRate}%</span>
            </div>
          ...
          <CardContent>
            {currentCampaign ? (
              ...
              <div className="text-center py-6">
                ...
                <Button variant="link" className="text-orange-400 text-xs mt-2" onClick={() => setActiveTab('call')}>
                  Launch one now
                </Button>
              </div>
            )}
        ...
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          ...
          <CardContent className="space-y-4 text-sm">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-orange-400">{credits}</span>
            </div>
            <div className="flex justify-between items-center">
      ...
      <div className={`grid gap-8 ${hasDailyData ? 'lg:grid-cols-2' : 'lg:grid-cols-1'}`}>
          ...
          <CardContent className="space-y-6 px-8 pb-8">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-5 space-y-2">
                ...
                <p className="text-2xl font-bold text-orange-400">{dailyReport.connectedCalls}</p>
              </div>
              <div className="rounded-2xl border border-zinc-800 bg-zinc-950/40 p-5 space-y-2">
        ...
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl border-orange-500/10">
          <CardHeader className="pb-8">
            <CardTitle className="text-xl flex items-center gap-2">
          ...
          <CardContent className="space-y-6 px-8 pb-8">
            ...
            <p className="text-sm text-zinc-300 leading-relaxed italic border-l-2 border-orange-500/50 pl-4">
              ...
              <div className="space-y-2">
                {workspaceIntelligence.nextActions.map((action: any) => (
                  <button
                    ...
                    className="w-full rounded-xl border border-zinc-800 bg-zinc-950/40 p-4 text-left hover:border-orange-500/30 transition-all group"
                  >
                    <div className="flex items-center justify-between gap-2">
                      <p className="text-sm font-semibold text-zinc-100 group-hover:text-orange-400 transition-colors">{action.title}</p>
