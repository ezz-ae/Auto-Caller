      ...
      <div className="space-y-4">
        {filteredLeads.length === 0 ? (
          <div className="py-20 md:py-32 text-center border-2 border-dashed border-zinc-800 rounded-3xl space-y-5 md:space-y-6">
            ...
            <Button size="lg" className="rounded-2xl h-14 px-8 font-bold bg-orange-400 hover:bg-orange-500 shadow-xl shadow-orange-400/10" onClick={() => setActiveTab('call')}>
                  ...
                  <div className="p-4 md:p-8 space-y-5 md:space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Badge className="bg-orange-400/10 text-orange-300 border-orange-400/20 text-[10px] uppercase font-bold py-1.5 px-3">Connected: {lead.connectedCalls}</Badge>
                            ...
                            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5 space-y-3 hover:bg-zinc-800/50 transition-colors">
                              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                <p className="text-sm font-bold text-zinc-200">
                                  {item.campaignName} • <span className="text-orange-300">{item.status}</span>
                                </p>
