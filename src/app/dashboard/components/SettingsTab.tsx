      ...
      <Card className="bg-zinc-900 border-zinc-800 shadow-xl overflow-hidden">
        ...
        <CardContent className="p-8 space-y-12">
          <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6 flex items-start gap-4">
            ...
            <div>
              <p className="text-base font-semibold text-emerald-300">Managed Intelligence Mode</p>
          ...
          <div className="space-y-8 pt-8 border-t border-zinc-800/50">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="space-y-3">
                <Label className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest text-emerald-400">Standard "Say This" Rules</Label>
                <Textarea
          ...
          <div className="p-8 rounded-[32px] border border-zinc-800 bg-zinc-950/20 flex flex-col md:flex-row md:items-center justify-between gap-6 group hover:border-emerald-500/20 transition-all duration-500">
          ...
          <div className="space-y-8 pt-8 border-t border-zinc-800/50">
            ...
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <Button
                ...
                className="bg-emerald-500 hover:bg-emerald-600 h-12 rounded-xl font-bold shadow-lg shadow-emerald-500/10"
              >
                Invite Member
              </Button>
            </div>
                  ...
                  <div key={member.id} className="p-6 rounded-2xl border border-zinc-800 bg-zinc-950/40 hover:border-zinc-700 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        size="sm"
                        variant="ghost"
                        className={`h-9 px-4 rounded-lg text-[10px] font-bold uppercase tracking-widest ${member.active ? 'text-emerald-400 hover:bg-emerald-500/5' : 'text-zinc-500'}`}
