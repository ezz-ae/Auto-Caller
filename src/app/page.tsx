      ...
      <main className="mx-auto max-w-7xl px-4">
        ...
        <section className="py-16 border-t border-zinc-800/60 space-y-8">
          <div className="text-center space-y-2">
            <p className="text-cyan-400 text-xs font-bold uppercase tracking-widest">How It Works</p>
        ...
        <section className="py-16 border-t border-zinc-800/60 space-y-8">
          <div className="text-center space-y-2">
            <p className="text-cyan-400 text-xs font-bold uppercase tracking-widest">Features</p>
        ...
        <section className="py-16 border-t border-zinc-800/60 space-y-8">
          <div className="text-center space-y-2">
            <p className="text-cyan-400 text-xs font-bold uppercase tracking-widest">Pricing</p>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {pricing.map(pack => (
              <div key={pack.calls} className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5 text-center">
                ...
                <p className="text-lg font-semibold text-cyan-400 mt-4">{pack.price}</p>
              </div>
            ))}
          </div>
          <div className="text-center">
            <Button asChild size="lg" className="h-12 px-8 rounded-xl bg-cyan-500 hover:bg-cyan-600">
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="space-y-5">
              <div className="space-y-1">
                <p className="text-cyan-400 text-xs font-bold uppercase tracking-widest">Live Demo</p>
        ...
        <section className="py-16 border-t border-zinc-800/60">
          <div className="rounded-2xl border border-cyan-500/25 bg-gradient-to-br from-cyan-500/10 via-cyan-500/5 to-transparent p-8 md:p-12 text-center space-y-6">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Button asChild size="lg" className="h-14 px-8 rounded-2xl text-base font-bold bg-cyan-500 hover:bg-cyan-600 shadow-xl shadow-cyan-500/20">
                <Link href="/login">
                  Start free / Create account
