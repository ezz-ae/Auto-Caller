    ...
    <div className="cw-editor-marketing min-h-screen text-white flex items-center justify-center p-4">
      <Card className="bg-gradient-to-br from-zinc-900/90 via-zinc-900/75 to-zinc-950/85 border-sky-400/20 max-w-md w-full">
        <CardHeader className="text-center">
          {status === 'loading' && (
            <>
              <Loader2 className="w-16 h-16 mx-auto mb-4 text-sky-300 animate-spin" />
          ...
          {status === 'success' && (
            <>
              <CheckCircle className="w-16 h-16 mx-auto mb-4 text-sky-300" />
              <CardTitle className="text-sky-300">Payment Successful!</CardTitle>
              <CardDescription>
                {assignedPhoneNumber
