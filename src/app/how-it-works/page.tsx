    ...
    <div className="cw-editor-marketing min-h-screen text-white">
      ...
      <main className="mx-auto max-w-6xl px-4 py-20 md:py-28 space-y-16">
        <section className="space-y-4 text-center">
          <p className="text-sky-300 text-sm font-semibold tracking-widest uppercase">Process</p>
        ...
        <section className="grid gap-4">
          {flow.map(item => (
            <Card key={item.step} className="bg-gradient-to-br from-zinc-900/90 via-zinc-900/70 to-zinc-950/80 border-sky-400/15">
              <CardHeader>
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs text-sky-300 font-semibold">STEP {item.step}</p>
        ...
        <section className="rounded-xl border border-sky-400/30 bg-gradient-to-r from-sky-500/10 via-blue-500/5 to-transparent p-5 md:p-6 space-y-3">
