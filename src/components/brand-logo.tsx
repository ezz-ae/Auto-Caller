...
export function BrandLogo({
  ...
  return (
    <Link href={href} className={`flex items-center gap-3 ${className}`.trim()} aria-label="Callware home">
      ...
      <span className="min-w-0 leading-tight">
        <span className={`block truncate text-sm font-bold tracking-tight text-white ${textClassName}`.trim()}>Callware</span>
        {showTagline ? (
