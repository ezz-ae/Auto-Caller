  ...
  if (result?.type === 'success') {
    return (
      <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-8 text-center space-y-4">
        ...
        <div>
          <p className="font-semibold text-emerald-200 text-lg">Call incoming</p>
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="h-12 px-5 rounded-xl bg-emerald-500 hover:bg-emerald-600 font-semibold shadow-lg shadow-emerald-500/20 shrink-0"
            >
              {loading ? (
          ...
          {consented && (
            <div className="rounded-xl border border-zinc-700/60 bg-zinc-800/40 p-4 space-y-3 animate-in fade-in-50 duration-200">
              ...
              <div className="flex gap-2">
                <Button
                  type="submit"
                  className="flex-1 h-10 rounded-xl bg-emerald-500 hover:bg-emerald-600 font-semibold"
                  disabled={loading}
                >
